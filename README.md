...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-strided-special-dmskramp/tags). For example,

```javascript
dmskramp = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-dmskramp@v0.1.1-umd/browser.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/math-strided-special-dmskramp.svg
[npm-url]: https://npmjs.org/package/@stdlib/math-strided-special-dmskramp

[test-image]: https://github.com/stdlib-js/math-strided-special-dmskramp/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/math-strided-special-dmskramp/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/math-strided-special-dmskramp/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/math-strided-special-dmskramp?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/math-strided-special-dmskramp.svg
[dependencies-url]: https://david-dm.org/stdlib-js/math-strided-special-dmskramp/main
...
[branches-url]: https://github.com/stdlib-js/math-strided-special-dmskramp/blob/main/branches.md
